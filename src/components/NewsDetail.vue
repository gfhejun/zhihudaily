<template>
	<div>
		<div class="my-img">
			...
			<div class="my-title">{{newsDetail.title}}</div>
			<div class="img-source">图片：{{newsDetail.image_source}}</div>
		</div>
		<div v-html="newsDetail.body">	
		</div>
	</div>
</template>
<script type="text/javascript">
	...
	export default{
		created(){
  		...
  		computed: mapState({
		    newsDetail: state => state.newsDetail.detail
		}),
		data(){
			return{
			}
